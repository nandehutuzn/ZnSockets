...
namespace Zn.Core.Sockets.Buffer
{
    public class SegmentBufferManager : ISegmentBufferManager
    {
        ...
        public static SegmentBufferManager Default {
            get {
                if (_defaultBufferManager != null) return _defaultBufferManager;

                var temp = new SegmentBufferManager(1024, 1024, 1);
                Interlocked.CompareExchange(ref _defaultBufferManager, temp, null);
        ...
        public int SegmentsCount { get { return _segments.Count; } }

        public int SegmentChunksCount { get { return _segmentChunks; } }

        public int AvailableBuffers { get { return _buffers.Count; } }

        public int TotalBufferSize { get { return _segments.Count * _segmentSize; } }
